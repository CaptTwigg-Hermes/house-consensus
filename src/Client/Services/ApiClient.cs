...
public sealed class ApiClient(HttpClient http)
{
    ...
    public async Task<HttpResponseMessage> CombineVotingIdentity(Guid primaryId, IReadOnlyCollection<Guid> memberIds, string previewToken, CancellationToken ct = default) => await RawAsync(HttpMethod.Post, "api/members/voting-identities/combine", new ConfirmVotingIdentities(primaryId, memberIds, previewToken), ct);
