...
def _completed_legacy_snapshot(path: Path) -> None:
    with sqlite3.connect(path) as conn:
        ...
        conn.execute("insert into pipeline_snapshot_items values (?, ?, ?, ?)", ("completed", "case-42", json.dumps({"caseID": "case-42", "address": {"roadName": "North Road", "houseNumber": "42", "cityName": "Copenhagen"}, "cashPrice": 2_500_000, "caseUrl": "https://example.test/case-42"}), json.dumps({"id": "case-42", "family_score": 88})))
