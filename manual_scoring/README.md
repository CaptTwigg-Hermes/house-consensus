...
- Failures are explicit and retryable (`retry_at`): source ambiguity, pipeline errors, and incomplete outputs. This worker does not spin/retry in-process; the store determines later scheduling.
